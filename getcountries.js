...
function getCountryDataByName(country_name){
  return country_name in country_data?country_data[country_name]:"invalid country"
...
// get currency by countryname
 function getCurrencyByCountryName(country_name){
  ...
  return country_name in country_data?country_data[country_name].currency:"invalid"
 }
